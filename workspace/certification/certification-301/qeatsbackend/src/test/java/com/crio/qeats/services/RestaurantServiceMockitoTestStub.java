...
public class RestaurantServiceMockitoTestStub {
  ...
  public void testFindNearbyWithin5km() throws IOException {
    ...
    when(restaurantRepositoryServiceMock.findAllRestaurantsCloseBy(eq(20.0), eq(30.0),
        eq(LocalTime.of(3, 0)), eq(5.0))) // Adjusted to match your test expectations
    ...
    verify(restaurantRepositoryServiceMock, times(1)).findAllRestaurantsCloseBy(eq(20.0), eq(30.0),
        eq(LocalTime.of(3, 0)), servingRadiusInKms.capture());
