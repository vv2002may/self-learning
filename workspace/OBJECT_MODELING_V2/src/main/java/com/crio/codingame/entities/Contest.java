...
public class Contest extends BaseEntity{
    ...
    // Throw InValidContestException if the above condition is not true. This will stop 
    // the Object Creation.
    //  Note:
    ...
    private void validateQuestionList(List<Question> qList, Level contestLevel) throws InvalidContestException {
         if(qList == null || contestLevel == null) throw new InvalidContestException("massage");
        
          for(Question i:qList){
            if(!i.getLevel().equals(contestLevel)) throw new InvalidContestException("massage");
