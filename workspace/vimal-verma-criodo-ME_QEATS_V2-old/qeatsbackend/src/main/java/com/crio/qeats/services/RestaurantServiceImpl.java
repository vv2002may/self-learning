...
/**
 * Get all the restaurants that are open now within a specific service radius. - For peak hours: 8AM
 * - 10AM, 1PM-2PM, 7PM-9PM - service radius is 3KMs. - All other times, serving radius is 5KMs. -
...
public class RestaurantServiceImpl implements RestaurantService {
  ...
  boolean isPeakHours(LocalTime t) {
    ...
    return (t.isAfter(t8) && t.isBefore(t10)) || (t.isAfter(t13) && t.isBefore(t14))
        || (t.isAfter(t19) && t.isBefore(t21))||t.equals(t8)||t.equals(t10)||t.equals(t13)||t.equals(t14)||t.equals(t19)||t.equals(t21);
  }
